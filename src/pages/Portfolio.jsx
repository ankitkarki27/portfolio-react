...
const Portfolio = () => {
  ...
  useEffect(() => {
    const handleHashChange = () => {
      ...
      if (hash && ['projects', 'work', 'education', 'blogs'].includes(hash)) {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      <nav className="fixed top-0 w-full bg-white/90 backdrop-blur-lg z-70 h-20">
        <div className="mx-auto px-2 sm:px-2 max-w-2xl h-full">
          <div className="flex justify-between items-center h-full">
            ...
            <div className="hidden md:flex items-center space-x-6">
              {['projects', 'work', 'blogs'].map((section) => (
                <button
                  key={section}
